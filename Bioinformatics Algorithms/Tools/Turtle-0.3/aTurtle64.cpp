...
bool quake;
void usage(){
	cout<<"aTurtle64 Usage:"<<endl;
	cout <<"aTurtle64 [arguments]"<<endl;
	cout<<"example: ./aTurtle64 -f 1Mreads.fq -o kmer_counts -k 31 -n 35000000"<<endl;
	  ...
	  while ((argc > 1) )
		{
			...
			switch (argv[1][1])
			{
				...
				case 'k':
					...
					if (kmer_length>64){
						cout<<" ERROR: aTurtle64 can handle k-mers of length up to 64."<<endl;
						return 0;
						}
					break;
				case 'n':
