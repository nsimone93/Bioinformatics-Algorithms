...
void usage(){
	cout<<"cTurtle32 Usage:"<<endl;
	cout <<"cTurtle32 [arguments]"<<endl;
	cout<<"example: ./cTurtle32 -f 1Mreads.fq -o kmer_counts -k 31 -n 6000000 -t 9"<<endl;
	  ...
	  while ((argc > 1) )
		{
			...
			switch (argv[1][1])
			{
				...
				case 'k':
					...
					if (kmer_length>32){
						cout<<" ERROR: cTurtle32 can handle k-mers of length up to 32. Please try cTurtle64."<<endl;
						return 0;
						}
					break;
				case 'n':
